...
impl From<dprint_core::configuration::NewLineKind> for NewLineKind {
  fn from(value: dprint_core::configuration::NewLineKind) -> Self {
    match value {
      dprint_core::configuration::NewLineKind::LineFeed => NewLineKind::LF,
      dprint_core::configuration::NewLineKind::CarriageReturnLineFeed => NewLineKind::CRLF,
      _ => NewLineKind::LF,
    }
  }
}
